...
// cette classe va venir se placer devant le controller et transformer les exceptions qui sont générées
// ce sont des intercepteurs
// pour transformer ces exceptions en erreur
...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity <Object> handleMethodArgumentNotValid(
        ...
        return  ResponseEntity.status(status)
                .body("Phone Number format not valid");
    }
